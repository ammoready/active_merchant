...
class BlueDogCustomerVaultTest < Test::Unit::TestCase
  def setup
    @gateway = BlueDogCustomerVaultGateway.new(some_credential: 'login', another_credential: 'password')
  ...
  def successful_purchase_response
    %(
      ...
      $ DEBUG_ACTIVE_MERCHANT=true ruby -Itest \
        test/remote/gateways/remote_blue_dog_customer_vault_test.rb \
