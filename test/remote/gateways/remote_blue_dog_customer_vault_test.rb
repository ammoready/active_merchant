...
class RemoteBlueDogCustomerVaultTest < Test::Unit::TestCase
  def setup
    @gateway = BlueDogCustomerVaultGateway.new(fixtures(:blue_dog_customer_vault))
  ...
  def test_invalid_login
    gateway = BlueDogCustomerVaultGateway.new(login: '', password: '')
